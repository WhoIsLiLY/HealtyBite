...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Total Orders -->
        <div
            class="bg-gradient-to-r from-blue-100 to-blue-200 p-6 rounded-2xl shadow hover:shadow-lg transition duration-300">
        ...
        <!-- Total Revenue -->
        <div
            class="bg-gradient-to-r from-green-100 to-green-200 p-6 rounded-2xl shadow hover:shadow-lg transition duration-300">
            <div class="flex items-center justify-between mb-3">
                ...
                <svg class="w-6 h-6 text-green-700" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <path
                        d="M12 2v2m0 16v2m8-8h2M2 12H0m17.657-6.343l1.414-1.414M4.929 19.071l-1.414 1.414M19.071 19.071l1.414-1.414M4.929 4.929L3.515 3.515" />
                </svg>
            </div>
        ...
        <!-- Top Product -->
        <div
            class="bg-gradient-to-r from-purple-100 to-purple-200 p-6 rounded-2xl shadow hover:shadow-lg transition duration-300">
            <div class="flex items-center justify-between mb-3">
